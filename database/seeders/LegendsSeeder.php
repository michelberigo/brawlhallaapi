...
class LegendsSeeder extends Seeder
{
    ...
    public function run()
    {
        $legends = [
            ...
            ['name' => 'Magyar', 'gender' => 'Male', 'first_weapon_id' => Weapon::WEAPON_GRAPPLE_HAMMER, 'second_weapon_id' => Weapon::WEAPON_GREATSWORD, 'strength' => 5, 'dexterity' => 4, 'defense' => 9, 'speed' => 4, 'price' => 5400, 'new' => true],
